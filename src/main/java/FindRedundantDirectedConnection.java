...
public class FindRedundantDirectedConnection {
    public static void main(String[] args) {
        Assert.assertEquals(findRedundantDirectedConnection(new int[][]{new int[]{1, 2}, new int[]{2, 3}, new int[]{3, 4}, new int[]{1, 4}, new
                int[]{1, 5}}), new int[]{1, 4});
        Assert.assertEquals(findRedundantDirectedConnection(new int[][]{new int[]{1, 2}, new int[]{1, 3}, new int[]{2, 3}}), new int[]{2, 3});
    }
